...
export default function FinancialDashboard() {
  ...
  const handleSendChat = async () => {
    ...
    try {
      ...
      const res = await fetch('https://fe-bank-1.onrender.com/ai/chatbot', {
        method: 'POST',
  ...
  useEffect(() => {
    const fetchFinancialData = async () => {
      try {
        ...
        const response = await fetch('https://fe-bank-1.onrender.com/financial/dashboard', {
          method: 'GET',
          headers: {
  ...
  const handleExportExcel = async () => {
    try {
      ...
      const role = localStorage.getItem('role');
              ...
              const response = await fetch('https://fe-bank-1.onrender.com/financial/export?format=excel', {
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`,
          'user-role': role
